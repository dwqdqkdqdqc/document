...
(
    ...
    name_3                      VARCHAR      NULL,
    name_4                      VARCHAR      NULL,
    zzsrm_stcd_1                VARCHAR      NULL,
    zzsrm_stcd_2                VARCHAR      NULL,
    zzsrm_stcd_3                VARCHAR      NULL,
    zzsrm_rw_code_1             VARCHAR      NULL,
    zzsrm_rw_freight_yard_1     VARCHAR      NULL,
    zzsrm_rw_station_code_1     VARCHAR      NULL,
    zzsrm_rw_cuscode_1          VARCHAR      NULL,
    zzsrm_rw_code_2             VARCHAR      NULL,
    zzsrm_rw_station_code_2     VARCHAR      NULL,
    zzsrm_rw_freight_yard_2     VARCHAR      NULL,
    zzsrm_rw_cuscode_2          VARCHAR      NULL,
    zzsrm_rw_code_3             VARCHAR      NULL,
    zzsrm_rw_station_code_3     VARCHAR      NULL,
    zzsrm_rw_cuscode_3          VARCHAR      NULL,
    zzsrm_rw_code_4             VARCHAR      NULL,
    zzsrm_rw_station_code_4     VARCHAR      NULL,
    zzsrm_rw_cuscode_4          VARCHAR      NULL,
    zzsrm_rw_code_5             VARCHAR      NULL,
    zzsrm_rw_station_code_5     VARCHAR      NULL,
    zzsrm_rw_cuscode_5          VARCHAR      NULL,
    zzsrm_post_code             VARCHAR      NULL,
    zzsrm_country               VARCHAR      NULL,
    zzsrm_region                VARCHAR      NULL,
    zzsrm_city                  VARCHAR      NULL,
    zzsrm_street                VARCHAR      NULL,
    zzsrm_str_suppl             VARCHAR      NULL,
    zzsrm_house_num             VARCHAR      NULL,
    zzsrm_house_num2            VARCHAR      NULL,
    zzsrm_post_code2            VARCHAR      NULL,
    zzsrm_country2              VARCHAR      NULL,
    zzsrm_region2               VARCHAR      NULL,
    zzsrm_city2                 VARCHAR      NULL,
    zzsrm_street2               VARCHAR      NULL,
    zzsrm_str_suppl2            VARCHAR      NULL,
    zzsrm_house_num_2           VARCHAR      NULL,
    zzsrm_house_num2_2          VARCHAR      NULL,
    zzsrm_rw_code_6             VARCHAR      NULL,
    zzsrm_rw_station_code_6     VARCHAR      NULL,
    zzsrm_rw_cuscode_6          VARCHAR      NULL,
    department                  VARCHAR      NULL,
    function                    VARCHAR      NULL,
    name_last                   VARCHAR      NULL,
    name_first                  VARCHAR      NULL,
    tel_number                  VARCHAR      NULL,
    tel_extens                  VARCHAR      NULL,
    fax_number                  VARCHAR      NULL,
    fax_extens                  VARCHAR      NULL,
    zzsrm_country_4             VARCHAR      NULL,
    zzsrm_region_4              VARCHAR      NULL,
    zzsrm_district_4            VARCHAR      NULL,
    zzsrm_city_4                VARCHAR      NULL
);
