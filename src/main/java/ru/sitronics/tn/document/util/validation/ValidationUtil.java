package ru.sitronics.tn.document.util.validation;

import ru.sitronics.tn.document.HasId;
import ru.sitronics.tn.document.util.exception.ErrorType;
import ru.sitronics.tn.document.util.exception.IllegalRequestDataException;
